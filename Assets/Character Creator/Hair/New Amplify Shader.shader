...
Shader "New Amplify Shader"
{
	Properties
	{
		...
		_AlphaMultiply("Alpha Multiply", Range( 0 , 1)) = 0
		_TextureSample2("Texture Sample 2", 2D) = "white" {}
		_DepthMultiply("Depth Multiply", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Color0;
			float4 _TextureSample12_ST;
			float4 _Sampler8723_TexelSize;
						...
						)
			{
				...
				float2 uv_TextureSample12 = packedInput.ase_texcoord5.xy * _TextureSample12_ST.xy + _TextureSample12_ST.zw;
				float2 temp_output_85_0_g1 = tex2D( _TextureSample12, uv_TextureSample12 ).rg;
				float2 UV110_g1 = temp_output_85_0_g1;
				float4 TexelSize110_g1 = _Sampler8723_TexelSize;
				...
				float4 break134_g1 = tex2D( _Sampler8723, UV0110_g1 );
				float S0128_g1 = break134_g1.r;
				float4 break136_g1 = tex2D( _Sampler8723, UV1110_g1 );
				float S1128_g1 = break136_g1.r;
				float4 break138_g1 = tex2D( _Sampler8723, UV2110_g1 );
				...
				float2 uv_TextureSample2 = packedInput.ase_texcoord5.xy * _TextureSample2_ST.xy + _TextureSample2_ST.zw;
				
				surfaceDescription.BaseColor = ( tex2D( _TextureSample0, uv_TextureSample0 ) * _Color0 ).rgb;
				surfaceDescription.Normal = localCombineSamplesSharp128_g1;
				...
				surfaceDescription.Alpha = ( tex2D( _TextureSample1, uv_TextureSample1 ) * _AlphaMultiply ).r;
				...
				surfaceDescription.Thickness = ( tex2D( _TextureSample2, uv_TextureSample2 ) * _DepthMultiply ).r;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float localCalculateUVsSharp110_g1 = ( 0.0 );
				float2 uv_TextureSample12 = packedInput.ase_texcoord2.xy * _TextureSample12_ST.xy + _TextureSample12_ST.zw;
				float2 temp_output_85_0_g1 = tex2D( _TextureSample12, uv_TextureSample12 ).rg;
				float2 UV110_g1 = temp_output_85_0_g1;
				float4 TexelSize110_g1 = _Sampler8723_TexelSize;
				float2 UV0110_g1 = float2( 0,0 );
				...
				float2 uv_TextureSample1 = packedInput.ase_texcoord2.xy * _TextureSample1_ST.xy + _TextureSample1_ST.zw;
				
				float2 uv_TextureSample2 = packedInput.ase_texcoord2.xy * _TextureSample2_ST.xy + _TextureSample2_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_TextureSample1 = packedInput.ase_texcoord1.xy * _TextureSample1_ST.xy + _TextureSample1_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float localCalculateUVsSharp110_g1 = ( 0.0 );
				float2 uv_TextureSample12 = packedInput.ase_texcoord3.xy * _TextureSample12_ST.xy + _TextureSample12_ST.zw;
				float2 temp_output_85_0_g1 = tex2D( _TextureSample12, uv_TextureSample12 ).rg;
				float2 UV110_g1 = temp_output_85_0_g1;
				float4 TexelSize110_g1 = _Sampler8723_TexelSize;
				float2 UV0110_g1 = float2( 0,0 );
		...
		Pass
		{
						...
						)
			{
				...
				float localCalculateUVsSharp110_g1 = ( 0.0 );
				float2 uv_TextureSample12 = packedInput.ase_texcoord7.xy * _TextureSample12_ST.xy + _TextureSample12_ST.zw;
				float2 temp_output_85_0_g1 = tex2D( _TextureSample12, uv_TextureSample12 ).rg;
				float2 UV110_g1 = temp_output_85_0_g1;
				float4 TexelSize110_g1 = _Sampler8723_TexelSize;
				float2 UV0110_g1 = float2( 0,0 );
				...
				float2 uv_TextureSample2 = packedInput.ase_texcoord7.xy * _TextureSample2_ST.xy + _TextureSample2_ST.zw;
...
Node;AmplifyShaderEditor.SamplerNode;12;-624.5754,135.863;Inherit;True;Property;_TextureSample1;Texture Sample 1;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-307.111,216.5302;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;16;-606.3599,511.8758;Inherit;True;Property;_TextureSample2;Texture Sample 2;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-572.5319,420.8002;Inherit;False;Property;_AlphaMultiply;Alpha Multiply;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-212.132,530.0911;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-528.45,750.847;Inherit;False;Property;_DepthMultiply;Depth Multiply;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;11;-618.4481,-282.614;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-302.2659,-95.2578;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;19;-608.3405,-49.63184;Inherit;False;Property;_Color0;Color 0;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;398.4795,-12.37514;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;14;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;33;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;True;0;True;_StencilRefGBuffer;255;False;;255;True;_StencilWriteMaskGBuffer;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;False;True;0;True;_ZTestGBuffer;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;39;Surface Type;0;0;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;1;0;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;0;0;Forward Only;0;0;  Energy Conserving Specular;1;0;  Transmission;1;0;Receive Decals;1;0;Receives SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;DOTS Instancing;0;0;GPU Instancing;1;0;LOD CrossFade;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position;1;0;0;11;True;True;True;True;True;True;False;False;False;True;True;False;;False;0
Node;AmplifyShaderEditor.SamplerNode;24;-312.7147,68.97639;Inherit;True;Property;_TextureSample12;Texture Sample 12;6;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;23;7.085322,49.47638;Inherit;False;Normal From Texture;-1;;1;9728ee98a55193249b513caf9a0f1676;13,149,0,147,0,143,0,141,0,139,0,151,0,137,0,153,0,159,0,157,0,155,0,135,0,108,0;4;87;SAMPLER2D;_Sampler8723;False;85;FLOAT2;0,0;False;74;SAMPLERSTATE;0;False;91;FLOAT;1.5;False;2;FLOAT3;40;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;25;-75.48815,348.8455;Inherit;False;Property;_Smoothness;Smoothness;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
WireConnection;0;1;23;40
WireConnection;0;7;25;0
WireConnection;0;9;15;0
WireConnection;0;16;17;0
WireConnection;23;85;24;0
ASEEND*/
//CHKSM=C5EE6E52F1E9DA3F573C2CA77DFE5FF2AA444B33